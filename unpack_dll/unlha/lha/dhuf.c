...
#include "lha.h"
   ...
   static void reconst(int , int);
   static int swap_inc(int);
   static void update_c(int);
   static void update_p(int);
   static void make_new_node(int);
   static void encode_c_dyn(unsigned int);
