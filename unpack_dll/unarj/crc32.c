...
lt_1:
                ...
                mov     bx, di
                shl     bx, 1
                mov     word ptr crc32tab_lo[ebx], dx
                mov     word ptr crc32tab_hi[ebx], ax
                inc     di
  }
lt_0:
  asm{
...
lt_accterm:
  ...
  asm{
                ...
                mov     di, bx
                shl     di, 1
                xor     cx, crc32tab_lo[edi]
                xor     dx, crc32tab_hi[edi]
                mov     bl, cl
                xor     bl, ah
                mov     cl, ch
                mov     ch, dl
...
stracc:
  asm{
                ...
                mov     di, bx
                shl     di, 1
                xor     cx, word ptr crc32tab_lo[edi]
                xor     dx, word ptr crc32tab_hi[edi]
  }
str_nchar:
  asm{
                lodsb
...
unsigned long crc32_for_char(unsigned long crc32_term, unsigned char newc)
{
  ...
  asm{
                ...
                mov     bh, 0
                shl     bx, 1
                xor     ax,word ptr  crc32tab_lo[ebx]
                xor     dx, word ptr  crc32tab_hi[ebx]
  }
 #else
