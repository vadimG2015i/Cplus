/*
 * $Id: externs.h,v 1.1.1.1 2002/03/28 00:02:52 andrew_belov Exp $
 * ---------------------------------------------------------------------------
...
#if TARGET==UNIX
extern struct hl_entries hl_entries;
#endif
...
extern unsigned short left[2*NCC-1];
extern unsigned short right[2*NCC-1];
extern unsigned char c_len[NCC];
