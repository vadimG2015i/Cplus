/*
 * $Id: msgbind.c,v 1.2 2002/12/13 21:49:44 andrew_belov Exp $
 * ---------------------------------------------------------------------------
...
static char systems[128];      /* {DOS, OS2} */
...
void put_hdr(FILE *file, char *name, char *src)
{
 ...
 fprintf(file, "/*\n"
          " * %-29s, %04u/%02u/%02u\n"
          " * ---------------------------------------------------------------------------\n"
          " * Do not modify this file. It is automatically generated from by MSGBIND from\n"
          " * %s.\n"
