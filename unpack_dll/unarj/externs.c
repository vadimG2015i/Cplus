/*
 * $Id: externs.c,v 1.2 2002/04/08 22:07:24 andrew_belov Exp $
 * ---------------------------------------------------------------------------
...
unsigned short left[2*NCC-1];            /* Huffman tree */
unsigned short right[2*NCC-1];           /* Huffman tree */
unsigned char c_len[NCC];                /* Character length */
...
int crit_eas;                           /* 1 if only critical EAs should
                                           be packed/restored */
int symlink_accurancy;                  /* Restore symlink properties */
