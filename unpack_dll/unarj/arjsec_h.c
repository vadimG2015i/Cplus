/*
 * $Id: arjsec_h.c,v 1.2 2002/04/08 22:07:24 andrew_belov Exp $
 * ---------------------------------------------------------------------------
...
int get_arjsec_signature(FILE *stream, long offset, char *signature, int iter)
{
 ...
 if(crc32term!=*(unsigned long *)&tail[ARJSEC_RECORD_SIZE-4])
  return(1);
 dest=tail+40;
 for(i=0; i<76; i++)
