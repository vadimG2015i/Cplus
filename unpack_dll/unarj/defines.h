/*
 * $Id: defines.h,v 1.2 2002/07/04 22:27:10 andrew_belov Exp $
 * ---------------------------------------------------------------------------
...
#define MATCHBIT                   8
#define MAXMATCH                 256
#define NCC (UCHAR_MAX+MAXMATCH+2-THRESHOLD)
...
#define XW_MISMATCH                5    /* Comparision mismatch */
...
/* Maximum # of bytes to search for an archive header signature */
 ...
 #define HSLIMIT_ARJ         270000L
 #define HSLIMIT_ARJSFX       56000L
 #define HSLIMIT_ARJSFXJR     15000L
#else
...
#define SFX_COMMAND_SIZE          80    /* Length of SFX options in comment
...
#define HL_ENTRIES_INCREMENT     256    /* # of entries to reserve at once */
